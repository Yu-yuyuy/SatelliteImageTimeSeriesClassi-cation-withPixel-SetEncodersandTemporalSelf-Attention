...
本仓库围绕课程作业要求，完整复现了基于 PSE（Pixel-Set Encoder）+ TAE（Temporal Attention Encoder）架构的遥感影像像素级时空分类模型(论文来源DOI：**10.1109/CVPR42600.2020.01233**,参考仓库https://github.com/VSainteuf/pytorch-psetae?tab=readme-ov-file），从环境搭建到结果可视化完成全流程验证，重点验证该模型在 Sentinel-2 卫星影像数据集上的分类效果，同时全程注重项目的可复现性，确保实验流程可追溯、可重复。
